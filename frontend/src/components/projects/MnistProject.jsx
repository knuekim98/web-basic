...
const MnistProject = () => {
  ...
  return (
    <div className="min-h-screen p-8 md:p-20 flex flex-col items-center bg-[#0a0a0a] text-white">
      ...
      <div className="w-full flex flex-col lg:flex-row gap-12 md:gap-20 items-center justify-center">

        <div className="grow lg:max-w-xl flex flex-col md:flex-row gap-12 md:gap-20 items-center justify-center">
          {/* canvas */}
          ...
          <div className="flex flex-col gap-4 w-full max-w-[240px]">
            <button onClick={clearCanvas} className="w-full px-8 py-4 border border-white/5 hover:bg-white/5 flex items-center justify-center gap-3 transition-all text-[12px] tracking-widest uppercase">
              <RotateCcw size={14} /> Reset Canvas
            </button>
            <button 
              onClick={handlePredict} 
              disabled={isLoading}
              className="w-full px-8 py-4 bg-white text-black hover:bg-gray-200 disabled:bg-gray-600 flex items-center justify-center gap-3 transition-all text-[12px] font-bold tracking-widest uppercase"
            >
            ...
            <div className="mt-4 p-8 border border-white/5 bg-zinc-900/30 rounded-3xl text-center relative overflow-hidden group">
              <span className="text-[12px] text-gray-300 block mb-1 uppercase tracking-widest relative z-10">Result</span>
        ...
        {/* prob graph */}
        <div className="w-full max-w-sm bg-zinc-900/20 p-8 rounded-3xl border border-white/5">
          <p className="text-[12px] text-gray-300 uppercase tracking-widest mb-8 text-center">Probability Distribution</p>
